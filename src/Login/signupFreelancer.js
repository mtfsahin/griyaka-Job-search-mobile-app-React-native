...
class signupFreelancer extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  CreateAccount = () => {
    ...
    if (FirstName == "" || Email == "" || Password == "" || RetypePassword == "") {
          ...
          <RadioGroup
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TextInput
                ...
                placeholder={CONSTANT.SignupPnumber2}></TextInput>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TextInput
                style={{ fontSize: 17, color: '#323200032', height: 55, width: "90%" }}
                underlineColorAndroid="transparent"
                editable={true}
                placeholderTextColor="#999999"
            ...
            <>
              ...
              <View style={{ marginLeft: 15, marginRight: 15 }}>
                <MultiSelect
                  ...
                  styleDropdownMenuSubsection={{backgroundColor:'#fff' , paddingRight:-7  , height:60 , paddingLeft:10  , borderWidth:0.6 , borderColor:'#fff' , borderColor:'#909090' , borderRadius:4}}
