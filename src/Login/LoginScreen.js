...
class LoginScreen extends Component {
  ...
  login = () => {
    ...
    if (username == "") {
      ...
      this.setState({ email: "Lütfen telefon numaranızı giriniz." });
    } else if (reg.test(username) === false) {
      //alert("Email is Not Correct");
      this.setState({ email: "Telefon Numarası Doğru Değil." });
      return false;
    } else if (password == "") {
          ...
          <View style={styles.container}>
            ...
            <View
              ...
              <TextInput
                ...
                name="username"
                placeholder={CONSTANT.LoginPnumber}
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate("EmployerLogin", {
