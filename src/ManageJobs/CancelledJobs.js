                    ...
                    { item.hired_freelancer_title == null ?
                      <View style={styles.ManageJobsProjectsFreelancerMainArea}>
                        <View style={styles.ManageJobsProjectsInfoArea}>
                          ...
                          />
                          <Text numberOfLines={1} style={[styles.NameTextStyle,{marginLeft:10,width:"85%"}]}>
                            {item.employer_name}
                          </Text>
                        </View>
                      ...
                      <View style={styles.ManageJobsProjectsFreelancerMainArea}>
                        ...
                        <View style={{flexDirection:"row", alignItems:'center'}}>
                          <Text numberOfLines={1} style={[styles.SectionHeadingTextStyle,{marginLeft:10, color:"red",opacity:0.7}]}>
                            {"Reddedildi"}
                          </Text>
                        </View>
                      </View>
