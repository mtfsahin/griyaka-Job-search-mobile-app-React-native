...
class CustomHeader extends Component {
  ...
  render() {
    return (
      <View>
        {/* {Platform.OS === "android" ? */}
          <StatusBar backgroundColor="white" barStyle={Platform.OS === 'ios' ? "dark-content" : "light-content"} />
           {/* : 
          <StatusBar hidden /> */}
        {/* } */}
        <View
        ...
        >
          ...
          >
            <AntIcon name="back" size={25} color={"#000"} onPress={() => this.props.navigation.navigate("LoginScreen", {
