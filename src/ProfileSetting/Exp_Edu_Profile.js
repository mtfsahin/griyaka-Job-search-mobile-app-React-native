...
class Exp_Edu_Profile extends Component {
  ...
  state={
    ...
    ExpCompanyName: "",
    ExpDescription: "",
    ExpEndDate: "Çıkış Tarihi",
    ExpStartingDate: "Giriş Tarihi",
    ExpJobTitle: "",
    EduDescription: "",
    EduEndDate: "Mezuniyet",
    EduInstituteName: "",
    EduInstituteTitle: "",
    EduStartingDate: "Başlangıç tarihi",
    ExpRefresh: false,
    EduRefresh: false,
                        ...
                        <Collapse>
                          ...
                          <CollapseBody>
                            <View style={styles.PersonalDetailCollapseBodyArea}>
                              ...
                              >
                                <Text style={{ color: "#323232" }}>
                                  {this.state.EditEduStart == "Giriş tarihi" ? item.startdate.split(' ')[0] : this.state.EditEduStart}
                                </Text>
                                <TouchableOpacity
                              ...
                              >
                                <Text style={{ color: "#323232" }}>
                                  {this.state.EditEduEnd == "Çıkış Tarihi" ? item.enddate.split(' ')[0] : this.state.EditEduEnd}
                                </Text>
                                <TouchableOpacity
