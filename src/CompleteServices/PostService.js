...
class PostService extends Component {
  ...
  PostService = async () => {
    ...
    if (
      ...
      alert(`Minimum hizmet fiyatı aşağıdaki gibi olmalıdır:${this.state.themeSettingsMinimumPrice}`)
    }else {
      Alert.alert('Üzgünüm...', 'Tüm alanları doldurun.');
    }
  };
  pickMultiple() {
    try {
