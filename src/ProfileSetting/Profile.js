                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={[
                      ...
                      { color: CONSTANT.TextColorLight1, paddingLeft: 10 },
                    ]}>
              ...
              {/* Cinsiyet */}
               ...
               {(type !== 'employer' && this.state.themeSettingsGenderSetting == 'yes') &&
                <View style={[styles.profileInfoArea, { paddingBottom: -10 }]}>
                  <Text style={[styles.OtherTextStyle, styles.section, { height: 30 }]}>
              ...
              {this.state.themeSettingsAllowSkills == 'yes' &&
                <View style={{ padding: 10 }}>
                  <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                    <Text style={{ fontSize: 14 }}>Listede yeteneğinizi bulamadınız mı? </Text>
                    <TouchableOpacity
                      onPress={this.createSkillsBtn}
                    >
                      <Text style={{ fontSize: 14, fontWeight: '500', color: CONSTANT.primaryColor }}>Yetenek oluştur.</Text>
                    </TouchableOpacity>
                  </View>
